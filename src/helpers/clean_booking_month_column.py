# src/helpers/clean_booking_month_column.py

def clean_booking_month_column(df):
    """
    Clean the 'booking_month' column by converting it to a categorical data type.
    
    Parameters:
        df (pd.DataFrame): The input DataFrame.
    
    Returns:
        pd.DataFrame: A DataFrame with the 'booking_month' column converted to a categorical type.
    """
    # Define the column name to be cleaned
    column_name = 'booking_month'
