# src/helpers/clean_platform_column.py


def clean_platform_column(df):
    """
    Clean the 'platform' column by converting it to a categorical data type.

    Parameters:
        df (pd.DataFrame): The input DataFrame.

    Returns:
        pd.DataFrame: A DataFrame with the 'platform' column converted to a categorical type.
    """
